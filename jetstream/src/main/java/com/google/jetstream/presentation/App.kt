...
import com.google.jetstream.presentation.screens.movietype.MovieTypeListScreen
...
fun App(
    ...
    NavHost(
        ...
        builder = {
            ...
            composable(
                route = Screens.MovieTypeList(),
                arguments = listOf(
                    navArgument(MovieTypeListScreen.MovieTypeKey) {
                        type = NavType.StringType
                    }
                )
            ) {
            ...
            composable(route = Screens.Dashboard()) {
                DashboardScreen(
                    ...
                    openMovieTypeList = { movieType ->
                        navController.navigate(
                            Screens.MovieTypeList.withArgs(movieType)
                        )
                    },
